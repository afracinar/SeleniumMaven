...
public class C01_MavenIlkTest {
    ...
    public static void main(String[] args) {
        ...
        //note:list yapmadan xpath ile yaptık
        WebElement bulunanSonuc = driver.findElement(By.xpath("(//*[@class='sg-col-inner'])[1]"));
        System.out.println("Arama sonucu: "+bulunanSonuc.getText());
